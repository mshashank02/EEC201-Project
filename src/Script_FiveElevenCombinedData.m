%Script for Speaker Recognition with Five and Eleven Combined Dataset
%% Speaker Recognition System using MFCC and Vector Quantization
clear; clc; close all;

%% Paths for accessing training and testing datasets
trainDataPath = 'C:\Startup MATLAB\EEC201-Project-main\Data\FiveElevenComb-Train'; % Change path as needed
testDataPath = 'C:\Startup MATLAB\EEC201-Project-main\Data\FiveElevenComb-Test';    % Change path as needed
...
numTrainSpeakers = 46; % Number of training speakers
numTestSamples = 46;   % Number of testing samples
