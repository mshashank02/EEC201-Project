%Code with implemetation of Zero and Combined Zero Dataset with the non
%student zero calibration Dataset
%% Speaker Recognition System using MFCC and Vector Quantization
clear; clc; close all;

%% Paths for accessing training and testing datasets
trainDataPath = 'C:\Startup MATLAB\EEC201-Project-main\Data\ZeroComb-Train'; % Change path as needed
testDataPath = 'C:\Startup MATLAB\EEC201-Project-main\Data\ZeroComb-Test';    % Change path as needed
...
numTrainSpeakers = 20; % Number of training speakers
numTestSamples = 17;   % Number of testing samples
...
for testIdx = 1:numTestSamples
    ...
    % Check if the whole base name matches (ignoring case)
