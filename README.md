...
## **7. Example Output**
Table below showes the distance matrix that is generated by the scripts. Red shows misclassification of Training Data and green is correct classification of speech. The example output is using the Twelve Training and Testing Dataset from the 2024 student speech recording.
![Figure 1. Basic structures of speaker identification systems](images/Figure_DistMatrix.jpg)
